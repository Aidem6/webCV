  ...
  return (
    <div className={styles.card}>
      ...
      <InfoChunk
        ...
        date='2018 - 2022'
        h3='Computer science - Bachelor degree'
        description="I’m proud that for our engineering diploma thesis, I with my team have received the 2nd degree distinction in the Engineer 4 Science 2022 competition under the patronage of the Polish Section of IEEE."
      />
    </div>
  );
}